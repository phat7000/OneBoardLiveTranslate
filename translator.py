...
class Translator:
    ...
    def __init__(
        ...
        if self._overrides:
            log.info("Translator request overrides configured")
        if self._extra_body:
            # Provider-specific payloads are user-controlled and may contain
            # credentials. Record their presence without serializing values.
            log.info("Translator extra_body configured")
